...
|Velocidades|Média de velocidade (m/s)|Média da pressão (Pa)|Variância da velocidade (m^2/s^2)|Variância da pressão (Pa^2)|Desvio padrão - pressão (Pa)|Desvio padrão - velocidade (m/s)|Número de Reynolds|
|---|---|---|---|---|---|---|---|
|V1||||||||
|V2||||||||
|V3||||||||
